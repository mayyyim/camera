...
class Watermark34 extends WaterMarkWidget {
  const Watermark34({required WatermarkUIObject watermarkUIObject})
              ...
              child: Column(
                ...
                children: [
                  Visibility(
                    ...
                    child:
                        Image.network(watermarkUIObject.imageObject?.url ?? ""),
                  ),
                  Visibility(
  ...
  static Watermark34 defaultData() {
    return Watermark34(watermarkUIObject: WatermarkUIObject.defaultData());
  }
}
