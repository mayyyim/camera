...
class Watermark27 extends WaterMarkWidget {
  const Watermark27({required WatermarkUIObject watermarkUIObject})
  ...
  static Watermark27 defaultData() {
    return Watermark27(watermarkUIObject: WatermarkUIObject.defaultData());
  }
}
