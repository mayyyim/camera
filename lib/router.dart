...
import 'package:cameraApp/features/login/login_page.dart';
...
import 'package:cameraApp/features/vip/vip.dart';
import 'package:cameraApp/features/watermark/text_edit_page.dart';
  ...
  static init(
    ...
    _router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
            path: '/photo/edit/:isPhoto',
            builder: (context, state) => PhotoEditPage(
                  isPhoto: state.params['isPhoto']! == "true",
                )),
        GoRoute(
        ...
        GoRoute(path: '/vip', builder: (context, state) => VipPage()),
        GoRoute(
          path: '/edit/:title',
          builder: (context, state) => TextEditPage(state.params['title']!),
        )
      ],
