...
class CameraNotifier extends StateNotifier<CameraState> {
  ...
  void toggleMode(CameraMode cameraMode) {
    print("MJ: test toggle mode $cameraMode");
    state = state.copyWith(cameraMode: cameraMode);
  }
  ...
  Future<XFile?> stopRecording() async {
    try {
      return await state.cameraController!.stopVideoRecording();
    } on CameraException catch (e) {
      print(e);
      return null;
    }
  ...
  Future<XFile?> toggleRecording() async {
